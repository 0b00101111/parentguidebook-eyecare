// ============================================
// i18n Configuration for eyecare.parentguidebook.org
// ============================================

// --- 1. Astro Config (add to astro.config.mjs) ---
// 
...
//     locales: ['en', 'zh'],
//     routing: {
//       prefixDefaultLocale: true,  // /en/... and /zh/... (both prefixed)
//     },
//   },
// });
...
// --- 2. UI Translations ---
// Place this file at: src/i18n/ui.ts
...
export const ui = {
  en: {
    ...
    'urgency.routine': 'Follow regular schedule',
    ...
    'landing.hero.subheadline': "A free, evidence-based guide to children's eye health — written for parents, not doctors.",
    ...
    // Footer
    'footer.disclaimer': 'All content is for educational purposes only and is not a substitute for professional medical advice.',
    ...
    'disclaimer.text': 'This article is for educational purposes only and is not a substitute for professional medical advice, diagnosis, or treatment. If you have concerns about your child\'s vision or eye health, please consult a qualified eye care professional.',
  ...
  zh: {
    ...
    'landing.hero.subheadline': '一份免费的、基于医学证据的儿童眼健康指南——为家长而写，不是为医生而写。',
    ...
    'disclaimer.text': '本文仅供健康教育目的，不能替代专业医疗建议、诊断或治疗。如果您对孩子的视力或眼睛健康有任何担忧，请咨询合格的眼科专业人员。',
...
// --- 3. Helper functions ---
// Place this file at: src/i18n/utils.ts
...
//   // Converts /en/guides/newborn-eyes/ to /zh/guides/newborn-eyes/
